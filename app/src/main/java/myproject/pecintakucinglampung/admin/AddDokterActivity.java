...
public class AddDokterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(AddDokterActivity.this);
        ...
        pDialogLoading = new SweetAlertDialog(AddDokterActivity.this, SweetAlertDialog.PROGRESS_TYPE);
        ...
        ivDokter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(AddDokterActivity.this, new String[] {android.Manifest.permission.READ_EXTERNAL_STORAGE}, RC_PERMISSION_READ_EXTERNAL_STORAGE);
                } else {
        ...
        btnAlamat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    startActivityForResult(builder.build(AddDokterActivity.this), PLACE_PICKER_REQUEST);
    ...
    private void checkValidation() {
        ...
        if (getNama.equals("") || getNama.length() == 0 ||
                ...
                getJadwal.equals("") || getJadwal.length() == 0 || uri == null) {

            new SweetAlertDialog(AddDokterActivity.this,SweetAlertDialog.ERROR_TYPE)
    ...
    private void simpanData(){
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(AddDokterActivity.this, "Upload failed!\n" + exception.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(AddDokterActivity.this, "Upload finished!", Toast.LENGTH_SHORT).show();

                // save image to database
                final String urlGambar = downloadUrl.toString();
                Dokter dokter = new Dokter(etNama.getText().toString(),
                        etPhone.getText().toString(),
                        alamat,
                        etJadwal.getText().toString(),
                        etBidang.getText().toString(),
                        urlGambar,
                        latitude,
                        longitude
                        );
                dokter.setIdDokter(timeStamp);

                ref.document(timeStamp).set(dokter).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        pDialogLoading.dismiss();
                        if (task.isSuccessful()){
                            new SweetAlertDialog(AddDokterActivity.this,SweetAlertDialog.SUCCESS_TYPE)
                                    .setContentText("Data dokter disimpan")
    ...
    private void resetKomponen(){
        ...
        uri = null;
        ivDokter.setImageResource(R.drawable.pawprint);
    }
