...
public class JualBeliActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter     = new AdapterKucing(JualBeliActivity.this,kucingList);
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    for (DocumentSnapshot doc : task.getResult()){
                        if (doc.get("isDijual").equals("true")){
                    ...
                    pDialogLoading.dismiss();
                    new SweetAlertDialog(JualBeliActivity.this,SweetAlertDialog.ERROR_TYPE)
